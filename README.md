...
11. [Learning Days](#learning-days)
    ...
    * [Topic 3: HTML5 APIs](#topic-4-html5-apis)

    * [Topic 4: UI - ReactJS](#topic-5-optional-ui---reactjs)
...
One week for guided learning and three weeks for app development.
...
1. At least, two different browsers installed on the developer machine. Example, Chrome, Firefox.

2. The IDE to use is [SublimeText](http://www.sublimetext.com/) or [Atom](https://atom.io/).

3. Google Hangouts + headset (audio calls)
...
1. The first week will be used for intensive self learning. Each topic will have reading and practices parts. Tutors will be available to answer technical questions on a given chat room.

2. The next three weeks will be used to develop an application following a life process.
...
The test application will consist in a Spotify client.
